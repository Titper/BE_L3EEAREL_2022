...
void loop() {
    ...
    if (Serial.available()) {
        ...
        switch (data) {
            ...
            // 3
            case 51 : Serial.println("Sending 40 throttle");
                      motA.write(20);
                      motB.write(20);
                      motC.write(20);
                      motD.write(20);
            ...
            // 4
            case 52 : Serial.println("Sending 90 throttle");
                      do
                      {
                        Serial.println("test");
                        sensorValue1 = analogRead(A0);
                        sensorValue1 = ((sensorValue1-337) /337.0) * 347;
                        motB.write(sensorValue1);

                      }
                      while(sensorValue1 >= -40);
            break;
        }
    }
}
...
void displayInstructions()
{
    ...
    Serial.println("\t3 : Sends 40 throttle");
    Serial.println("\t3 : Sends commande throttle\n");
}
